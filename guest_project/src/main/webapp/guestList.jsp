...
<div class="container w-75 mt-5 mx-auto">
        ...
        <tbody>
            <c:forEach var="guest" items="${guestlist}" varStatus="status">
                <tr>
                    ...
                    <td>
                        <a href="/guest_project/guest.nhn?action=getGuest&aid=${guest.aid}" class="text-decoration-none">${guest.name}</a>
                    </td>
                    <td>${guest.email}</td>
                    <td>${guest.date}</td>
                    <td>${guest.title}</td>
    ...
    <div class="collapse" id="addForm">
        <div class="card card-body">
            <form method="post" action="/guest_project/guest.nhn?action=addGuest" enctype="multipart/form-data">
